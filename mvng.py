...
parser.usage="%prog [options] Moves a file from source to destination \nWritten by Markus Bawidamann D20200709 after having an unhappy run in with legacy the legacy mv command."
